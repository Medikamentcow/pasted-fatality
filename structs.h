...
struct player_log_t
{
	...
	struct anim_info_t
	{
		...
		float layer3_weight = 0.f, layer3_cycle = 0.f;
		float layer6_weight = 0.f, layer6_cycle = 0.f;
		float layer7_weight = 0.f, layer7_cycle = 0.f;
		float layer12_weight = 0.f, layer12_cycle = 0.f;

		// previous tick (for deltas)
		float prev_layer3_weight = 0.f, prev_layer3_cycle = 0.f;
		float prev_layer6_weight = 0.f, prev_layer6_cycle = 0.f;
		float prev_layer7_weight = 0.f, prev_layer7_cycle = 0.f;
		float prev_layer12_weight = 0.f, prev_layer12_cycle = 0.f;

		// derived deltas (filled in gather)
		float layer3_weight_delta = 0.f, layer3_cycle_delta = 0.f;
		float layer6_weight_delta = 0.f, layer6_cycle_delta = 0.f;
		float layer7_weight_delta = 0.f, layer7_cycle_delta = 0.f;
		float layer12_weight_delta = 0.f, layer12_cycle_delta = 0.f;

		// pose / move
		float eye_yaw = 0.f;
		float feet_yaw = 0.f;
		float eye_feet_delta = 0.f;
		float prev_feet_yaw = 0.f;
		float prev_eye_yaw = 0.f;
		float eye_yaw_delta = 0.f;   // vs previous record if useful

		float speed_2d = 0.f;
		float velocity_yaw = 0.f;
		float velocity_yaw_delta = 0.f; // eye - move direction

		bool on_ground = true;
		bool is_moving = false;
		bool is_standing = false;
		int  standing_ticks = 0;
		int  choke = 0;

		// flags only (still no resolve decision)
		bool lby_snapped = false;
		bool layer7_strafe_break = false;
		bool layer6_break = false;
		bool layer3_break = false;
	};
